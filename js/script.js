...
function carregarCarrinho() {
  ...
  fetch("http://127.0.0.1:4002/api/v1/carrinho/listar/" + 1)
    ...
    .then((dados) => {
      dados.payload.map((rs) => {
        let card = `<div class="card mb-3 col-md-7">
                <div class="row g-0">
                  <div class="col-md-3">
                  <img src=${rs.foto1} class="card-img-top" alt="...">
                </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      ...
                      <p class="card-text precoatual"" >${rs.precoatual}</p>
                      <select class="form-select form-select-lg mb-3" aria-label="Large select example" style="width:70px">
                      <option value="1">${rs.quantidade}</option>
    ...
    .then((dados) => {
      dados.payload.map((rs) => {
        ...
        <div class="card-body">
          ...
          <a href="#" class="btn btn-primary">Fechar pedido</a>
        </div>
      </div>`
